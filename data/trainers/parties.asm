...
WhitneyGroup:
	...
	db 20, MILTANK,    MOOMOO_MILK,  ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end
...
SchoolboyGroup:
	...
	db 37, VILEPLUME,  SOLARBEAM, SLEEP_POWDER, MOONBLAST, MOONLIGHT
	db -1 ; end
...
PicnickerGroup:
	...
	; PICNICKER (26)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 43, CLEFAIRY,   METRONOME, ENCORE, MOONLIGHT, MOONBLAST
	db -1 ; end
