...
.String_HallOfFame: db "EREGALERIJ@"
.String_TurnOff:    db "ZET UIT@"
...
.WithdrawItem: db "HAAL VOORWERP@"
.DepositItem:  db "STORT VOORWERP@"
.TossItem:     db "GOOI WEG@"
.MailBox:      db "MAILBOX@"
.Decoration:   db "DEOCRATIE@"
.TurnOff:      db "SCHAKEL UIT@"
.LogOff:       db "LOG UIT@"
